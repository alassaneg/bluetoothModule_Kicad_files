...
WT32i\nPrévoir capa de liaison sortie vers ampli, et molex (plus tard)
...
R41 = résistance de pull down (donc à relier à GND) pour reset MCU lors de test UART
Wire Wire Line
...
Peut être en entrée ou en sortie. \nMettre interrupteur pour sélectionner entrèe ou sortie(uniquement pour mono avec guitare)
...
Interrupteur(sert uniquement pour la batterie)\nSI USB branché, bypass de l'interrupteur\nRemplacer capa découplage reg113na
Text Notes 17400 10550 0    50   ~ 0
Si sortie = 1 => Interrupteur fermé (et éventuellement USB branché)(réveil le uc)/\n                   USB débranché et interrupteur ouvert = UC non alimenté\nSi sortie = 0 => USB branché et interrupteur ouvert \n                  (réveil UC, envoie commande SPI, on endort l'UC)
$Comp
L Device:LED D12
U 1 1 5E964E6F
P 17500 5200
...
LED indiquant si connecté(set control CD)
$Comp
L Device:LED D14
U 1 1 5EBA90B6
P 17450 6200
